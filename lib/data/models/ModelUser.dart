...
enum FollowingUrl {
  HTTPS_API_GITHUB_COM_USERS_FREE_CODE_CAMP_FOLLOWING_OTHER_USER
}
...
enum GistsUrl { HTTPS_API_GITHUB_COM_USERS_FREE_CODE_CAMP_GISTS_GIST_ID }

final gistsUrlValues = EnumValues({
  "https://api.github.com/users/freeCodeCamp/gists{/gist_id}":
      GistsUrl.HTTPS_API_GITHUB_COM_USERS_FREE_CODE_CAMP_GISTS_GIST_ID
});

enum Login { FREE_CODE_CAMP }

final loginValues = EnumValues({"freeCodeCamp": Login.FREE_CODE_CAMP});

enum NodeId { MD_EY_OK9_Y_Z2_FUA_XPHD_GLVBJK4_OTI1_MJ_I }

final nodeIdValues = EnumValues({
  "MDEyOk9yZ2FuaXphdGlvbjk4OTI1MjI=":
      NodeId.MD_EY_OK9_Y_Z2_FUA_XPHD_GLVBJK4_OTI1_MJ_I
});

enum StarredUrl { HTTPS_API_GITHUB_COM_USERS_FREE_CODE_CAMP_STARRED_OWNER_REPO }

final starredUrlValues = EnumValues({
  "https://api.github.com/users/freeCodeCamp/starred{/owner}{/repo}":
      StarredUrl.HTTPS_API_GITHUB_COM_USERS_FREE_CODE_CAMP_STARRED_OWNER_REPO
});
